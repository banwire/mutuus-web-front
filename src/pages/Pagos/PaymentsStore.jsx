...
import {PagosStoreButtonExport, OxxoTiendasPagoButton} from "../../components/ButtonContent"
...
export const PaymentsStore = () => {
  ...
  return (
    <PolizasLayout title="Realiza tu pago mediante tiendas de conveniencia" stepv={3}>
       <ProgressCircular open={loading} />
          <Grid container className='payments-store' direction="row" alignItems="center">
            ...
            <Grid container textAlign='center' sx={{padding:2}}  >
              <Grid item xs={12} sm={ 12 } md={12} lg={12}>
                <PagosStoreButtonExport  variant='contained' >
                    Descargar PDF
            ...
            <Grid container textAlign='center' sx={{mb: 1, padding:4}}  >
              <Grid item xs={12} sm={ 12 } md={12} lg={12}>
                <OxxoTiendasPagoButton variant='contained' onClick={handleClick}>
                 Continuar
